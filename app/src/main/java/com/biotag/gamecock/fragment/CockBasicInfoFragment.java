...
public class CockBasicInfoFragment extends SupportFragment {

    public static CockBasicInfoFragment newInstance(String json) {

        Bundle args = new Bundle();
        args.putString("cockbasicinfo",json);
        CockBasicInfoFragment fragment = new CockBasicInfoFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        json = bundle.getString("cockbasicinfo");
    }
